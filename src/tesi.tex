...
\input{capitoli/descrizione-stage}             % Introduzione
\input{capitoli/sprint-1}             % Processi
\input{capitoli/sprint-2}             % Kick-Off
\input{capitoli/sprint-3}             % Concept Preview
\input{capitoli/sprint-4}             % Product Prototype
\input{capitoli/sprint-5}             % Product Design Freeze e SOP
\input{capitoli/sprint-6}             % Conclusioni
\input{capitoli/sprint-7}
\input{capitoli/sprint-8}
